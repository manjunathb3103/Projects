...
function onSubmitCheck()
{
	...
	echo "<center>";
	echo "<form method =post name='form1' action=lab_login_verify.php onsubmit='return onSubmitCheck();'>";
	echo "<table border=4 bgcolor=lightyellow>";
	echo "<tr><td colspan=2 align=center><b>LOGIN</b></td></tr>
	...
	echo "</table>";
    echo"<a href='faculty.php'>faculty login</a>";
